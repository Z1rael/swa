...
| Images | Image searching, viewing, uploading and editing via third-party-apis. 
| Social-Functions | Liking, Commenting and various other social functions.
| Usermanagement | Provides various features related to the management of accounts.
Also includes tools related to the administration of the users.
| Copyright | Includes various tools to check for and verify potential copyright issues. 
...
==== White Box - Images BB_1
image::../../images/SWARC_Building_Block_2.drawio.svg[Whitebox PhotoHive]

The dotted lines show the general request flows, because the majority of the communication is handled via Apache Kafka as a message queue.
...
==== White Box Search-Service BB_1.1
image::../../images/SWARC_Building_Block_3.drawio.svg[Whitebox PhotoHive]
